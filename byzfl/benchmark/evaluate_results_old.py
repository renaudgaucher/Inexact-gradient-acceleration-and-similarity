                                ...
                                for lr in lr_list:
                                    for momentum in momentum_list:
                                        ...
                                        plt.plot(np.arange(nb_points)* (evaluation_delta if metric in ['test_accuracy', 'train_accuracy'] else 1), 
                                                mean_data, label=label, color=colors[color_index % len(colors)], linestyle=tab_sign[color_index % len(tab_sign)], marker=None, alpha = 0.8, markevery=1)#markers[color_index % len(markers)]
