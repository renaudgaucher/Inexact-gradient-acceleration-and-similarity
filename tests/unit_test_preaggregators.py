...
class TestClippedMixingAggregation:

    def setup_method(self):
        self.agg = byzfl.ClippedMixing(1)
        self.expected_np = np.array([[3, 4, 5, 0.],
                                     [4, 5, 6, 0.],
                                     [5, 6, 7, 0.]])
        self.expected_torch = torch.tensor([[3, 4, 5, 0.],
                                            [4, 5, 6, 0.],
                                            [5, 6, 7, 0.]])
